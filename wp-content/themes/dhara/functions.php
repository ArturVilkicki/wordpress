...
define('DHARA_THEME_URL','https://wpkoi.com/dhara-wpkoi-wordpress-theme/','dhara');
define('DHARA_WPKOI_AUTHOR_URL','https://wpkoi.com/','dhara');
define('DHARA_WPKOI_SOCIAL_URL','https://www.facebook.com/wpkoithemes/','dhara');
define('DHARA_WORDPRESS_REVIEW','https://wordpress.org/support/theme/dhara/reviews/?filter=5','dhara');
define('DHARA_DOCUMENTATION','https://wpkoi.com/docs/','dhara');
define('DHARA_FONT_AWESOME_LINK','https://fontawesome.com/icons','dhara');
